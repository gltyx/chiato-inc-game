...
var cnItems = {
    ...
    "Raising your prestige level requires having": "提高你的声望等级需要有",
    "Recruit": "招募",
    "Reset Game": "重置游戏",
    "s create": " 创建",
    ...
    "Upgrade Aircraft Plants": "升级飞机工厂",
    "": "",
    "": "",
    "": "",
    "": "",
...
var cnRegReplace = new Map([
    ...
    [/^Production increased by (.+) per Aircraft Plant$/, '每个 飞机厂 的产量增加了 $1'],
    ...
    [/^You currently own (.+) Aircraft Plants$/, '您当前拥有 $1 飞机厂'],
    ...
    [/^You currently own (.+) Aircraft Plant upgrades$/, '您当前拥有 $1 飞机厂 升级'],
