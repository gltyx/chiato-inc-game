...
var cnItems = {
    ...
    ". This enemy force has an Army strength of": ".这支敌军的陆军力量为",
    "About": "关于",
    "Aircraft": "飞机",
    "Aircraft Plant": "飞机厂",
    ...
    "Attacking now will require atleast 2,500 army forces and win up to $200,000. This enemy force has an Army strength of 5,000": "现在进攻将需要至少 2,500 名军队并赢得高达 200,000 美元的奖金。这支敌军的陆军兵力为 5,000",
    "Barrack": "营房",
    ...
    "strength by": "强度由",
    "Submarine": "潜艇",
    "Submarine Station": "海底站",
    "Take over new Territory": "接管新界",
    "Tank": "坦克",
    "Tank Plant": "罐厂",
    "Territory": "领土",
    "Territory: 1": "领土：1",
    "The basics of the game is to build Army strength with buildings.": "游戏的基础是用建筑物来建立军队的力量。",
    ...
    "Use your army to take over new Territory, this will cost army strength but more territory generates more income.": "用你的军队占领新的领土，这将消耗军队的力量，但更多的领土会产生更多的收入。",
    "Warfare": "战争",
    "wars won": "战争胜利",
    "Wars won: 0": "战争胜利：0",
    "Workshop": "作坊",
    ...
    "You then use this Army strength to go to war and earn money, or take over new territory to generate income.": "然后你利用这支军队的力量去打仗赚钱，或者占领新的领土来创造收入。",
    "Each Aircraft Plant increases army strength by 1800": "每个飞机厂增加军队力量 1800",
    "Each Barrack increases army strength by 1": "每个兵营增加 1 点军队力量",
    "Each Boot Camp increases army strength by 20": "每个新兵训练营增加 20 点军队力量",
    "Each Command School increases army strength by 500": "每个指挥学校增加军队力量 500",
    "Each FOB increases army strength by 300": "每个 FOB 增加军队力量 300",
    "Each Missile Silo increases army strength by 5000": "每个导弹发射井增加军队力量 5000",
    "Each Naval Academy increases army strength by 150": "每个海军学院增加 150 点军队力量",
    "Each Nuclear Missile Silo increases army strength by 10000": "每个核导弹发射井增加 10000 军队力量",
    "Each Shipyard increases army strength by 2500": "每个造船厂增加 2500 点军队力量",
    "Each Shooting Range increases army strength by 100": "每个射击场增加 100 点军队力量",
    ...
    "Each Tank Plant increases army strength by 1500": "每个坦克工厂增加军队力量 1500",
    "Each Workshop increases army strength by 800": "每个车间增加800军队力量",
    "Upgrade Barracks": "升级兵营",
    "You don't have enough army!": "你没有足够的军队！",
    "You must send more army!": "你必须派遣更多的军队！",
    "Upgrade Boot Camps": "升级新兵训练营",
    "You do not have enough army income to defend this territory, construct more buildings, you need atleast 1000 army per cycle.": "你没有足够的军队收入来保卫这片领土，建造更多的建筑，你每个周期至少需要 1000 军队。",
    "": "",
    "": "",
    "": "",
    "": "",
...
var cnRegReplace = new Map([
    ...
    [/^Production increased by (.+) per Boot Camp$/, '每个新兵训练营的产量增加了 $1'],
    [/^You currently own (.+) Boot Camp upgrades$/, '您当前拥有 $1 个新兵训练营升级'],
    [/^You currently own (.+) Boot Camps$/, '您当前拥有 $1 个新兵训练营'],
